...
<div class="col-md-10">
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<a href="index.blade.php" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> 分类页面</a>
		...
		<div class="panel-body">
			<form action="/admin/types" method="post">
				...
				<div class="form-group">
					...
					<input type="text" name="keywords" placeholder="请输入关键字" class="form-control" id="">
				</div>
				<div class="form-group">
					<label for="">DESCRIPTION</label>
					<input type="text" name="description" placeholder="请输入描述信息" class="form-control" id="">
				</div>
				<div class="form-group">
